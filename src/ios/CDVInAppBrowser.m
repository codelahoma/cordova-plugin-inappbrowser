...
- (void)createViews
{
    ...
    self.toolbar.barTintColor = [UIColor colorWithRed:0.0 green:100.0/255 blue:171.0/255 alpha:1.0];
    ...
    self.view.backgroundColor = [UIColor colorWithRed:0.0 green:100.0/255 blue:171.0/255 alpha:1.0];
